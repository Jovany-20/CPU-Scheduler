#include "../Header Files/PreemptivePriorityScheduler.h"
...
void PreemptivePriorityScheduler::schedule(bool& live) {
    ...
    while (live || completed < numProcesses) {
    ...
    cout << "\nAverage Waiting Time: "
        << static_cast<double>(totalWaitingTime) / numProcesses
        << "\nAverage Turnaround Time: "
        << static_cast<double>(totalTurnaroundTime) / numProcesses
        << endl;
}
