...
static constexpr auto qt_meta_stringdata_ZN27PreemptivePrioritySchedulerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN27PreemptivePrioritySchedulerE[] = {
...
Q_CONSTINIT const QMetaObject PreemptivePriorityScheduler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN27PreemptivePrioritySchedulerE.offsetsAndSizes,
    qt_meta_data_ZN27PreemptivePrioritySchedulerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN27PreemptivePrioritySchedulerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PreemptivePriorityScheduler, std::true_type>,
...
void PreemptivePriorityScheduler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (PreemptivePriorityScheduler::*)(double , double );
            if (_q_method_type _q_method = &PreemptivePriorityScheduler::statsCalculated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (PreemptivePriorityScheduler::*)(int , int );
            if (_q_method_type _q_method = &PreemptivePriorityScheduler::updateGanttChart; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (PreemptivePriorityScheduler::*)();
            if (_q_method_type _q_method = &PreemptivePriorityScheduler::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *PreemptivePriorityScheduler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN27PreemptivePrioritySchedulerE.stringdata0))
