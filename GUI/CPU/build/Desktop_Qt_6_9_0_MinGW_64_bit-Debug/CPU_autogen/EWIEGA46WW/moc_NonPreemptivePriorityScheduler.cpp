...
template <> constexpr inline auto NonPreemptivePriorityScheduler::qt_create_metaobjectdata<qt_meta_tag_ZN30NonPreemptivePrioritySchedulerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<NonPreemptivePriorityScheduler, qt_meta_tag_ZN30NonPreemptivePrioritySchedulerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject NonPreemptivePriorityScheduler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN30NonPreemptivePrioritySchedulerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN30NonPreemptivePrioritySchedulerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN30NonPreemptivePrioritySchedulerE_t>.metaTypes,
    nullptr
} };
...
void NonPreemptivePriorityScheduler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NonPreemptivePriorityScheduler::*)(double , double )>(_a, &NonPreemptivePriorityScheduler::statsCalculated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NonPreemptivePriorityScheduler::*)(int , int )>(_a, &NonPreemptivePriorityScheduler::updateGanttChart, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (NonPreemptivePriorityScheduler::*)()>(_a, &NonPreemptivePriorityScheduler::finished, 2))
            return;
    }
}
...
void *NonPreemptivePriorityScheduler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN30NonPreemptivePrioritySchedulerE_t>.strings))
