...
static constexpr auto qt_meta_stringdata_ZN19RoundRobinSchedulerE = QtMocHelpers::stringData(
    "RoundRobinScheduler",
    "updateGanttChart",
    "",
    "pid",
...
Q_CONSTINIT static const uint qt_meta_data_ZN19RoundRobinSchedulerE[] = {
...
Q_CONSTINIT const QMetaObject RoundRobinScheduler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19RoundRobinSchedulerE.offsetsAndSizes,
    qt_meta_data_ZN19RoundRobinSchedulerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19RoundRobinSchedulerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<RoundRobinScheduler, std::true_type>,
...
void RoundRobinScheduler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (RoundRobinScheduler::*)(int , int );
            if (_q_method_type _q_method = &RoundRobinScheduler::updateGanttChart; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (RoundRobinScheduler::*)(double , double );
            if (_q_method_type _q_method = &RoundRobinScheduler::statsCalculated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (RoundRobinScheduler::*)();
            if (_q_method_type _q_method = &RoundRobinScheduler::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *RoundRobinScheduler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19RoundRobinSchedulerE.stringdata0))
