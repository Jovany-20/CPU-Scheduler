...
static constexpr auto qt_meta_stringdata_ZN15SchedulerWorkerE = QtMocHelpers::stringData(
    "SchedulerWorker",
    "updateGanttChart",
    "",
    "pid",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15SchedulerWorkerE[] = {
...
Q_CONSTINIT const QMetaObject SchedulerWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15SchedulerWorkerE.offsetsAndSizes,
    qt_meta_data_ZN15SchedulerWorkerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15SchedulerWorkerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SchedulerWorker, std::true_type>,
...
void SchedulerWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SchedulerWorker::*)(int , int );
            if (_q_method_type _q_method = &SchedulerWorker::updateGanttChart; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (SchedulerWorker::*)();
            if (_q_method_type _q_method = &SchedulerWorker::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *SchedulerWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15SchedulerWorkerE.stringdata0))
