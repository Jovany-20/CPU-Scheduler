...
static constexpr auto qt_meta_stringdata_ZN25SJFNonPreemptiveSchedulerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN25SJFNonPreemptiveSchedulerE[] = {
...
Q_CONSTINIT const QMetaObject SJFNonPreemptiveScheduler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN25SJFNonPreemptiveSchedulerE.offsetsAndSizes,
    qt_meta_data_ZN25SJFNonPreemptiveSchedulerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN25SJFNonPreemptiveSchedulerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SJFNonPreemptiveScheduler, std::true_type>,
...
void SJFNonPreemptiveScheduler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SJFNonPreemptiveScheduler::*)(double , double );
            if (_q_method_type _q_method = &SJFNonPreemptiveScheduler::statsCalculated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (SJFNonPreemptiveScheduler::*)(int , int );
            if (_q_method_type _q_method = &SJFNonPreemptiveScheduler::updateGanttChart; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (SJFNonPreemptiveScheduler::*)();
            if (_q_method_type _q_method = &SJFNonPreemptiveScheduler::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *SJFNonPreemptiveScheduler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN25SJFNonPreemptiveSchedulerE.stringdata0))
